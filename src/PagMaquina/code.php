    ...
    <main class="max-w-[1440px] mx-auto px-6 lg:px-12 py-12">
        ...
        <section class="mb-12">
            ...
            <div class="flex flex-col md:flex-row justify-between items-start md:items-end gap-6">
                ...
                <div class="text-right">
                    ...
                    <p id="preco" class="text-4xl font-headline font-bold text-on-surface">
        ...
        <section class="mb-16">
            ...
            <div class="relative overflow-hidden rounded-md h-[520px] lg:h-[960px] bg-surface-container-low group">
                ...
                <!-- Main Image -->
                <img id="carouselImage" class="w-full h-full object-cover transition-all duration-500"
                ...
                <!-- Counter -->
                <div
                    class="absolute bottom-4 right-4 bg-black/60 text-white px-3 py-1 rounded-full text-xs font-medium z-20">
            ...
            <div class="flex justify-center mt-4">
                <div id="thumbnailsContainer" class="flex gap-2 overflow-x-auto px-2">
                </div>
            </div>
            ...
            <div class="lg:col-span-8 space-y-16">
                ...
                <div>
                    ...
                    <div class="flex items-center gap-3 bg-surface-container-low p-4 rounded-md mt-3">
                        ...
                        <div>
                            <p class="text-[10px] uppercase tracking-widest text-outline font-semibold mb-1">Provedor
                            </p>
                ...
                <div class="lg:col-span-4">
                        ...
                        <div class="sticky top-24">
                            ...
                            <div
                                class="bg-surface-container-lowest p-8 rounded-md shadow-2xl shadow-black/5 border border-outline-variant/20">
                                ...
                                <div class="mb-8">
                                    ...
                                    <div class="grid gap-4">
                                        ...
                                        <div class="relative">
                                            ...
                                            <label
                                                class="absolute -top-2 left-3 bg-white px-1 text-[10px] uppercase tracking-widest text-outline font-bold">
                                                Data Inicial
                                            </label>
                                ...
                                <div class="space-y-4 mb-8">
                                    ...
                                    <div id="extrasOptions" class="mb-2" style="display:none;">
                                        <div id="operadorOption" class="flex items-center gap-3 mb-1" style="display:none;">
                                            ...
                                            <label for="optOperador" class="text-sm">Adicionar operador (<span
                                                    id="operadorPriceLabel">R$ 0</span>/dia)</label>
                                        </div>

                                        <div id="freteOption" class="flex items-center gap-3" style="display:none;">
                                            <input type="checkbox" id="optFrete" />
                                            <label for="optFrete" class="text-sm">Adicionar frete (<span
                                                    id="fretePriceLabel">R$ 0</span>)</label>
                                        </div>
                                    </div>
                                ...
                                <button onclick="openDisableAccountModal()"
                                    class="signature-gradient w-full py-5 rounded-md text-white font-headline font-bold uppercase tracking-widest text-sm active:scale-95 transition-all">
                                    Alugar Agora
                                </button>
                                <p id="pErro" style="color: red"><?php if (isset($responseError))
                                    echo $responseError; ?></p>
                            </div>
        ...
        <div class="bg-white dark:bg-[#1c1b1b] rounded-lg shadow-xl max-w-sm w-full mx-4">
            ...
            <div class="p-6 border-t border-stone-200 dark:border-stone-700 flex gap-3">
                <button onclick="closeDisableAccountModal()"
                    class="flex-1 px-4 py-2 border-2 border-stone-300 dark:border-stone-600 text-stone-600 dark:text-stone-400 rounded-md font-bold text-xs uppercase hover:bg-stone-50 dark:hover:bg-stone-900 transition-colors">Cancelar</button>
                <button onclick="confirmDisableAccount()"
                    class="flex-1 px-4 py-2 bg-yellow-500 hover:bg-yellow-600 text-white rounded-md font-bold text-xs uppercase transition-colors">Confirmar
                    Aluguel</button>
            </div>
        </div>
    </div>
    ...
    <script>
        ...
        function initializeCarousel() {
            ...
            images.forEach((img, index) => {
                ...
                thumbnail.className = `w-24 h-24 object-cover rounded cursor-pointer transition-all ${index === 0 ? "ring-2 ring-primary" : "opacity-70 hover:opacity-100"
                    }`;
